# EDINET 財務履歴データ取り込み 設計書（④ EPS CAGR・⑦ 売上高CAGR・⑥ 配当維持可能年数・⑤ ROE 5年平均の入力）
...
- ただし **EDINET は営業利益率を返さない**（有報のハイライト表に営業利益が無い）ので、
  その列は [import-review.md](./import-review.md) §5.5 の**規則2**
